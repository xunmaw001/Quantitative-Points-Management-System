            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item label="报名审核">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.indexNameSearch" placeholder="报名审核" clearable></el-input>
                    </el-form-item>
                    <el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                //本表的
                params['dicCode'] = "huodongbaoming_yesno_types"//编码名字
                params['dicName'] = "报名审核",//汉字名字
                this.$http({
                    url: "dictionary/page",
                    method: "get",
                    params: params
