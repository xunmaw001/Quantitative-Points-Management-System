    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodongbaoming !=null){
            ...
            BeanUtils.copyProperties( huodongbaoming , view );//把实体数据重构到view中
                ...
                if(huodongfabu != null){
                    BeanUtils.copyProperties( huodongfabu , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setHuodongfabuId(huodongfabu.getId());
                }
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(huodongbaoming.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongbaomingEntity huodongbaoming, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongbaoming.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<HuodongbaomingEntity> queryWrapper = new EntityWrapper<HuodongbaomingEntity>()
            ...
            .eq("yonghu_id", huodongbaoming.getYonghuId())
            .eq("huodongbaoming_yesno_types", huodongbaoming.getHuodongbaomingYesnoTypes())
            .eq("huodongbaoming_yesno_text", huodongbaoming.getHuodongbaomingYesnoText())
            ;
...
//                            huodongbaomingEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            huodongbaomingEntity.setHuodongbaomingYesnoTypes(Integer.valueOf(data.get(0)));   //报名审核 要改的
//                            huodongbaomingEntity.setHuodongbaomingYesnoText(data.get(0));                    //审核结果 要改的
