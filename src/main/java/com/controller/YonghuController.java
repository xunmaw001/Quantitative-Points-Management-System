    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者联系方式或者学生身份证号已经被使用");
        }
    }
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setUsername(data.get(1));                    //账户 要改的
                            yonghuEntity.setYonghuName(data.get(2));                    //学生姓名 要改的
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(3)));   //性别 要改的
                            yonghuEntity.setXueyuanTypes(Integer.valueOf(data.get(4)));   //学院 要改的
                            yonghuEntity.setZhuanyeTypes(Integer.valueOf(data.get(5)));   //专业 要改的
                            yonghuEntity.setBanjiTypes(Integer.valueOf(data.get(6)));   //班级 要改的
                            yonghuEntity.setYonghuPhone(data.get(7));                    //联系方式 要改的
                            yonghuEntity.setJifenNumber(Integer.valueOf(data.get(8)));   //关量化积分 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("yonghuPhone")){
                                    ...
                                    yonghuPhone.add(data.get(7));//要改的
                                }else{
                        ...
                        //查询是否重复
                         //学号
                        List<YonghuEntity> yonghuEntities_yonghuUuidNumber = yonghuService.selectList(new EntityWrapper<YonghuEntity>().in("yonghu_uuid_number", seachFields.get("yonghuUuidNumber")).eq("yonghu_delete", 1));
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者联系方式或者学生身份证号已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
        return R.ok();
